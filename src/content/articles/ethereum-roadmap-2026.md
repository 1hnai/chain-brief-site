...
description: "The Surge, The Scourge, The Verge, The Purge, The Splurge. Vitalik laid out the phases years ago. Here's an honest look at what's shipped, what's still in progress, and where the L2 network stands today."
category: "Deep Dive"
...
## The L2 network: maturity and fragmentation

The most visible change in Ethereum's development over the past two years has been the rise of L2s as the primary user-facing layer. The combination of EIP-4844's fee reductions and continued infrastructure maturation has made rollups the default environment for most Ethereum activity.

Arbitrum, Optimism, and Base collectively handle the majority of Ethereum-network transaction volume. The OP Stack (powering Optimism, Base, and a growing cohort of "Superchain" members) has emerged as the dominant rollup framework, though zkEVM rollups - particularly zkSync and Polygon's AggLayer - are competitive and continuing to mature.
...
Full interoperability between L2s - where the difference between Arbitrum and Base is as invisible to users as the difference between two bank branches - remains unfinished. It's the most important UX problem in the Ethereum network today.
...
The remaining roadmap items - Verkle trees, full Danksharding, protocol-enshrined PBS - are less glamorous than The Merge but no less important. They're the work of making the base layer stable, decentralised, and efficient enough to serve as credibly neutral infrastructure for the decades ahead.
